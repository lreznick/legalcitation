...
'''def test_GetCitations():           
    assert_equal(GetCitations(" 2008 SCC 9 (CanLII); [2008] 1 SCR 190, 229 NBR (2d) 1; 291 DLR (4th) 577; 64 CCEL (3d) 1; 69 Admin LR (4th) 1", "SCC", 2008, False), ", 2008 SCC 9, [2008] 1 SCR 190.")
'''
